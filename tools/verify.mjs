...
ok('comparaison stricte, jamais vide contre vide', /if\(!emp \|\| !codeAdulteEmpreinte \|\| emp!==codeAdulteEmpreinte\)/.test(js));
ok('empreinte transmise à la galerie publiée', /function liensPublies/.test(js) && /_ca:codeAdulteEmpreinte/.test(js));
